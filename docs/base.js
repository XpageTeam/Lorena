...
/*!*************************************************************************!*\
  !*** ./node_modules/css-loader??ref--6-1!./src/css/jquery.fancybox.css ***!
  \*************************************************************************/
...
var content = __webpack_require__(/*! !../../node_modules/css-loader??ref--6-1!./jquery.fancybox.css */ "./node_modules/css-loader/index.js?!./src/css/jquery.fancybox.css");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return stringEffect; });
...
function () {
  ...
  _createClass(stringEffect, [{
    ...
    key: "destroyStrings",
    value: function destroyStrings() {
      this.$el.children("div").children("span").unwrap();
    }
  }, {
    key: "createStrings",
    value: function createStrings() {
      var $text = this.$el.children("span"),
          stringsDesc = [];
      $text.each(function (i, el) {
        var $this = $(el); // console.log(parseInt($this.position().top);
    ...
    key: "wrapStrings",
    value: function wrapStrings() {
      var stringsDesc = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
      this.stringCounter = 0;
      var _this$settings$option = this.settings.options,
          delay = _this$settings$option.timeStep,
          tmOffset = _this$settings$option.timeOffset,
          transStep = _this$settings$option.transformStep,
          transStepOffset = _this$settings$option.transformStepOffset;
      var _iteratorNormalCompletion2 = true;
      var _didIteratorError2 = false;
      var _iteratorError2 = undefined;

      try {
        for (var _iterator2 = stringsDesc[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
},[["./src/js/common.js","runtime","vendors"]]]);

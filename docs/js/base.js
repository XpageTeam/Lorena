...
document.addEventListener("DOMContentLoaded", function () {
  var formId = "#popup-callorder";

  if (!js_cookie__WEBPACK_IMPORTED_MODULE_0___default.a.get("isCallPopupShowed")) {
    var targetBtn = document.querySelector(".btn-fix[href='".concat(formId, "']"));
    if (!targetBtn || !document.querySelector(formId)) return;
    var callPopupShowingTimeout = setTimeout(function () {
      $.fancybox.open({
        src: formId,
        afterClose: function afterClose() {
          js_cookie__WEBPACK_IMPORTED_MODULE_0___default.a.set("isCallPopupShowed", "1", {
            expires: 30
          });
        }
      });
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    selectCity: function selectCity(city) {
      if (city.id == this.curCityId) return;
  ...
  computed: {
    cities: function cities() {
      ...
      return this.citiesList.filter(function (city) {
        return ~city.name.toLowerCase().indexOf(_this.citySearchInput.toLowerCase());
      });
    },
    curCity: function curCity() {
      ...
      return this.citiesList.filter(function (city) {
        return city.id == _this2.curCityId;
      })[0];
    }
  },
  template: '\
...
/* harmony import */ var _stringAnimate_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./stringAnimate.js */ "./src/js/stringAnimate.js");
/* harmony import */ var _select2_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./select2.js */ "./src/js/select2.js");
/* harmony import */ var _select2_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_select2_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var js_cookie__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! js-cookie */ "./node_modules/js-cookie/src/js.cookie.js");
/* harmony import */ var js_cookie__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(js_cookie__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _city_select_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./city-select.js */ "./src/js/city-select.js");
/* harmony import */ var _stock_popup_showing_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./stock-popup-showing.js */ "./src/js/stock-popup-showing.js");
/* harmony import */ var _call_popup_showing_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./call-popup-showing.js */ "./src/js/call-popup-showing.js");
/* harmony import */ var _upload_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./upload.js */ "./src/js/upload.js");
/* harmony import */ var _size_popup_showing_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./size-popup-showing.js */ "./src/js/size-popup-showing.js");
/* harmony import */ var swiper_dist_js_swiper_esm_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! swiper/dist/js/swiper.esm.js */ "./node_modules/swiper/dist/js/swiper.esm.js");
...
if (typeof Vue != "undefined") Vue.component("city-select", _city_select_js__WEBPACK_IMPORTED_MODULE_5__["default"]);
...
__webpack_require__(/*! ./flipclock.min.js */ "./src/js/flipclock.min.js");
...
window.animateScroll = function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("html, body").animate({
    scrollTop: document.body.classList.contains("main") || document.body.classList.contains("tovar") ? window.matchMedia("(max-width: 1200px)").matches ? offset - parseInt(getComputedStyle(document.querySelector(".head")).height) - 40 : offset : offset - parseInt(getComputedStyle(document.querySelector(".head")).height)
  });
};
...
window.moveCareerForm = function (appendTo) {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(appendTo).find("div").replaceWith(jquery__WEBPACK_IMPORTED_MODULE_0___default()("#form-about-career"));
};

window.reinitSelect2 = function (formId) {
  var vue = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("".concat(formId, " .select2-container")).remove();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("".concat(formId, " select")).each(function () {
    if (!is_js__WEBPACK_IMPORTED_MODULE_1___default.a.touchDevice()) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).removeClass("select2-hidden-accessible");
      var self = this;
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).select2({
        ...
        language: {
          noResults: function noResults() {
            return jquery__WEBPACK_IMPORTED_MODULE_0___default()(self).attr("data-v-model") == 'selectShop' ? "Сначала выберите город" : "Нет информации для отображения";
          }
        }
      });
      if (vue) jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).on("select2:select", function (e) {
        vue[e.currentTarget.getAttribute("data-v-model")] = e.currentTarget.value;
      });
    } else jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass("selectized");
  });
};
...
var checScrollIntoView = function checScrollIntoView() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".about-text__desc:not(.js__show), .cw-item:not(.js__show), \
		.mission:not(.js__show), .timeline:not(.js__show)").each(function () {
    if (isScrolledIntoView(this)) jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass("js__show");
  });
};
...
try {
  document.addEventListener("DOMContentLoaded", function (e) {
    ...
    if (typeof Vue != "undefined") new Vue({
      el: ".head__city"
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".city-popup__btns .gray-btn, .side-menu__city .h-city").on("click", function () {
      window.citySelect.showCityPopup();
    });
    checScrollIntoView();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scroll("scroll resize", checScrollIntoView);
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".fancybox-map").fancybox({
      trapFocus: false,
      touch: false,
      buttons: ["fullscreen", "close"],
      beforeShow: function beforeShow() {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("body").addClass("js__fancybox-map");
      },
      afterClose: function afterClose() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".main-slide__title-title, \
			...
			.for-about .mission-desc__title-title").each(function (i, el) {
      new _stringAnimate_js__WEBPACK_IMPORTED_MODULE_2__["default"]({
        selector: el
      });
    });
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".career-slider__slide").fancybox({
      trapFocus: false,
      touch: false,
      loop: true,
      buttons: ["fullscreen", "slideShow", "close"],
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("body").on("click", ".f-list__item-title", function () {
...
try {
  document.addEventListener("DOMContentLoaded", function (e) {
    ...
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(".bx-yandex-map").length) jquery__WEBPACK_IMPORTED_MODULE_0___default()("html").addClass("js__iframe-map");
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".f-menu__item--title:first-child:last-child").each(function (i) {
    if (i > 0) return;
    var $cloned = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).clone();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest(".f-menu").next(".f-menu").append($cloned);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest(".f-menu").remove();
  });
  /** Сраный IE */

  if (is_js__WEBPACK_IMPORTED_MODULE_1___default.a.ie()) jquery__WEBPACK_IMPORTED_MODULE_0___default()("picture").each(function () {
    var $this = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    var src = $this.find("source:first-child").attr("data-srcset") || $this.find("source:first-child").attr("srcset");
...
try {
  document.addEventListener("DOMContentLoaded", function (e) {
    ...
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.sk-img-cont').length) {
...
try {
  document.addEventListener("DOMContentLoaded", function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cs__item:first-child').addClass('active');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cs__item').click(function () {
      var $this = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this),
          itemId = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).index();
      stageSlider.slideTo(itemId);
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cs__item').each(function (i, el) {
        var $this = jquery__WEBPACK_IMPORTED_MODULE_0___default()(el);
        $this.removeClass('active');
      });
      $this.addClass('active');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cs__list').find('.cs__item');
    });
    var stageSlider = new swiper_dist_js_swiper_esm_js__WEBPACK_IMPORTED_MODULE_10__["Swiper"]('.cs-slider .swiper-list', {
      slidesPerView: 1,
      centeredSlides: true,
      on: {
        transitionEnd: function transitionEnd() {
          var indexSlide = stageSlider.realIndex;
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cs__item').removeClass('active');
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cs__item:eq(' + indexSlide + ')').addClass('active');
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("body").on('click', '[href^="#"]', function (e) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('html,body').stop().animate({
        scrollTop: jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.hash).offset().top - jquery__WEBPACK_IMPORTED_MODULE_0___default()("header").height()
      }, 1000);
    });
  });
} catch (e) {
...
!function (a) {
  ...
  _FlipClock = function FlipClock(a, b, c) {
    ...
    constructor: function constructor(b, c) {
      "object" != _typeof(b) && (b = {}), "object" != _typeof(c) && (c = {}), this.setOptions(a.extend(!0, {}, b, c));
    },
  ...
  _FlipClock.Face = _FlipClock.Base.extend({
    ...
    createList: function createList(a, b) {
      "object" == _typeof(a) && (b = a, a = 0);
      var c = new _FlipClock.List(this.factory, a, b);
  ...
  _FlipClock.Factory = _FlipClock.Base.extend({
    ...
    constructor: function constructor(b, c, d) {
      d || (d = {}), this.lists = [], this.running = !1, this.base(d), this.$el = a(b).addClass(this.classes.wrapper), this.$wrapper = this.$el, this.original = c instanceof Date ? c : c ? Math.round(c) : 0, this.time = new _FlipClock.Time(this, this.original, {
        minimumDigits: this.minimumDigits,
        animationRate: this.animationRate
      }), this.timer = new _FlipClock.Timer(this, d), this.loadLanguage(this.language), this.loadClockFace(this.clockFace, d), this.autoStart && this.start();
    },
    loadClockFace: function loadClockFace(a, b) {
      var c,
          d = "Face",
          e = !1;
      return a = a.ucfirst() + d, this.face.stop && (this.stop(), e = !0), this.$el.html(""), this.time.minimumDigits = this.minimumDigits, c = _FlipClock[a] ? new _FlipClock[a](this, b) : new _FlipClock[this.defaultClockFace + d](this, b), c.build(), this.face = c, e && this.start(), this.face;
    },
    loadLanguage: function loadLanguage(a) {
      var b;
      return b = _FlipClock.Lang[a.ucfirst()] ? _FlipClock.Lang[a.ucfirst()] : _FlipClock.Lang[a] ? _FlipClock.Lang[a] : _FlipClock.Lang[this.defaultLanguage], this.lang = b;
    },
    localize: function localize(a, b) {
      var c = this.lang;
      if (!a) return null;
      var d = a.toLowerCase();
      return "object" == _typeof(b) && (c = b), c && c[d] ? c[d] : a;
    },
  ...
  _FlipClock.Time = _FlipClock.Base.extend({
    ...
    minimumDigits: 0,
    constructor: function constructor(a, b, c) {
      "object" != _typeof(c) && (c = {}), c.minimumDigits || (c.minimumDigits = a.minimumDigits), this.base(c), this.factory = a, b && (this.time = b);
    },
  ...
  _FlipClock.CounterFace = _FlipClock.Face.extend({
    ...
    constructor: function constructor(a, b) {
      "object" != _typeof(b) && (b = {}), a.autoStart = b.autoStart ? !0 : !1, b.autoStart && (this.shouldAutoIncrement = !0), a.increment = function () {
  ...
  _FlipClock.Lang.Arabic = {
    ...
    minutes: "دقائق",
    seconds: "ثواني"
  }, _FlipClock.Lang.ar = _FlipClock.Lang.Arabic, _FlipClock.Lang["ar-ar"] = _FlipClock.Lang.Arabic, _FlipClock.Lang.arabic = _FlipClock.Lang.Arabic;
}(jQuery), function (a) {
  _FlipClock.Lang.Danish = {
    ...
    minutes: "Minutter",
    seconds: "Sekunder"
  }, _FlipClock.Lang.da = _FlipClock.Lang.Danish, _FlipClock.Lang["da-dk"] = _FlipClock.Lang.Danish, _FlipClock.Lang.danish = _FlipClock.Lang.Danish;
}(jQuery), function (a) {
  _FlipClock.Lang.German = {
    ...
    minutes: "Minuten",
    seconds: "Sekunden"
  }, _FlipClock.Lang.de = _FlipClock.Lang.German, _FlipClock.Lang["de-de"] = _FlipClock.Lang.German, _FlipClock.Lang.german = _FlipClock.Lang.German;
}(jQuery), function (a) {
  _FlipClock.Lang.English = {
    ...
    minutes: "Minutes",
    seconds: "Seconds"
  }, _FlipClock.Lang.en = _FlipClock.Lang.English, _FlipClock.Lang["en-us"] = _FlipClock.Lang.English, _FlipClock.Lang.english = _FlipClock.Lang.English;
}(jQuery), function (a) {
  _FlipClock.Lang.Spanish = {
    ...
    minutes: "Minutos",
    seconds: "Segundos"
  }, _FlipClock.Lang.es = _FlipClock.Lang.Spanish, _FlipClock.Lang["es-es"] = _FlipClock.Lang.Spanish, _FlipClock.Lang.spanish = _FlipClock.Lang.Spanish;
}(jQuery), function (a) {
  _FlipClock.Lang.Finnish = {
    ...
    minutes: "Minuuttia",
    seconds: "Sekuntia"
  }, _FlipClock.Lang.fi = _FlipClock.Lang.Finnish, _FlipClock.Lang["fi-fi"] = _FlipClock.Lang.Finnish, _FlipClock.Lang.finnish = _FlipClock.Lang.Finnish;
}(jQuery), function (a) {
  _FlipClock.Lang.French = {
    ...
    minutes: "Minutes",
    seconds: "Secondes"
  }, _FlipClock.Lang.fr = _FlipClock.Lang.French, _FlipClock.Lang["fr-ca"] = _FlipClock.Lang.French, _FlipClock.Lang.french = _FlipClock.Lang.French;
}(jQuery), function (a) {
  _FlipClock.Lang.Italian = {
    ...
    minutes: "Minuti",
    seconds: "Secondi"
  }, _FlipClock.Lang.it = _FlipClock.Lang.Italian, _FlipClock.Lang["it-it"] = _FlipClock.Lang.Italian, _FlipClock.Lang.italian = _FlipClock.Lang.Italian;
}(jQuery), function (a) {
  _FlipClock.Lang.Latvian = {
    ...
    minutes: "Minūtes",
    seconds: "Sekundes"
  }, _FlipClock.Lang.lv = _FlipClock.Lang.Latvian, _FlipClock.Lang["lv-lv"] = _FlipClock.Lang.Latvian, _FlipClock.Lang.latvian = _FlipClock.Lang.Latvian;
}(jQuery), function (a) {
  _FlipClock.Lang.Dutch = {
    ...
    minutes: "Minuten",
    seconds: "Seconden"
  }, _FlipClock.Lang.nl = _FlipClock.Lang.Dutch, _FlipClock.Lang["nl-be"] = _FlipClock.Lang.Dutch, _FlipClock.Lang.dutch = _FlipClock.Lang.Dutch;
}(jQuery), function (a) {
  _FlipClock.Lang.Norwegian = {
    ...
    minutes: "Minutter",
    seconds: "Sekunder"
  }, _FlipClock.Lang.no = _FlipClock.Lang.Norwegian, _FlipClock.Lang.nb = _FlipClock.Lang.Norwegian, _FlipClock.Lang["no-nb"] = _FlipClock.Lang.Norwegian, _FlipClock.Lang.norwegian = _FlipClock.Lang.Norwegian;
}(jQuery), function (a) {
  _FlipClock.Lang.Portuguese = {
    ...
    minutes: "Minutos",
    seconds: "Segundos"
  }, _FlipClock.Lang.pt = _FlipClock.Lang.Portuguese, _FlipClock.Lang["pt-br"] = _FlipClock.Lang.Portuguese, _FlipClock.Lang.portuguese = _FlipClock.Lang.Portuguese;
}(jQuery), function (a) {
  ...
  _FlipClock.Lang.Swedish = {
    ...
    minutes: "Minuter",
    seconds: "Sekunder"
  }, _FlipClock.Lang.sv = _FlipClock.Lang.Swedish, _FlipClock.Lang["sv-se"] = _FlipClock.Lang.Swedish, _FlipClock.Lang.swedish = _FlipClock.Lang.Swedish;
}(jQuery), function (a) {
...
document.addEventListener("DOMContentLoaded", function () {
  if (!js_cookie__WEBPACK_IMPORTED_MODULE_0___default.a.get("home-popup-visible-new") && document.querySelector("#popup-size")) setTimeout(function () {
    jquery__WEBPACK_IMPORTED_MODULE_1___default.a.fancybox.open({
      src: "#popup-size",
      afterShow: function afterShow() {
        js_cookie__WEBPACK_IMPORTED_MODULE_0___default.a.set("home-popup-visible-new", "1");
      }
    });
  }, 300);else {
    var visibleCounter = parseInt(js_cookie__WEBPACK_IMPORTED_MODULE_0___default.a.get("home-popup-visible-new"));
    js_cookie__WEBPACK_IMPORTED_MODULE_0___default.a.remove("home-popup-visible-new", {
      path: ""
    });

    if (visibleCounter < 4) {
      visibleCounter++;
      js_cookie__WEBPACK_IMPORTED_MODULE_0___default.a.set("home-popup-visible-new", visibleCounter);
    }
  }
});
...
document.addEventListener("DOMContentLoaded", function () {
  if (!js_cookie__WEBPACK_IMPORTED_MODULE_0___default.a.get("stay-home-popup-showed") && document.querySelector("#popup-stocks")) setTimeout(function () {
    jquery__WEBPACK_IMPORTED_MODULE_1___default.a.fancybox.open({
      src: "#popup-stocks",
      beforeShow: function beforeShow() {
      ...
      afterClose: function afterClose() {
        ...
        js_cookie__WEBPACK_IMPORTED_MODULE_0___default.a.set("stay-home-popup-showed", "true");
      }
    });
    var popupLink = document.querySelector(".popup-stocks__link");
    if (!popupLink) return;
...
document.addEventListener("DOMContentLoaded", function (e) {
      ...
      for (var _iterator = list[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        window.observer.push(new MutationObserver(function (mutations) {
          mutations.forEach(function (mutation) {
            var input = mutation.addedNodes[0].querySelector(".forms-input-cont--file .forms__input--file");
  ...
  if (!jquery__WEBPACK_IMPORTED_MODULE_0___default()('div').hasClass('upload-gallery')) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("body").on("change", ".forms__input--file", function (e) {
      var value = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this)[0].files[0].name,
          inputHasFile = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).next('input[type="text"]').val(value);

      if (inputHasFile.length) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).nextAll('.default-input__label-img').remove();
      }
    });
  }

  jquery__WEBPACK_IMPORTED_MODULE_0___default()("body").on("change", ".upload-gallery .forms__input--file", function (e) {
    var time = +new Date();
    var $this = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    var getName = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest('.forms__input-cont--multiple').find('.default-input__img').siblings('.imagesFoto').attr("name");
    var value = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this)[0].files[0].name,
        inputHasFile = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).next('input[type="text"]').val(value);

    if (inputHasFile.length) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.upload-gallery .forms__input-cont--multiple').prepend('<div class="forms__input-cont forms-input-cont--file" data-el-id="' + time + '">\
						...
						<label class="forms__label--file default-input__label-img" for="' + time + '">Выбрать изображение</label>\
					</div>');
    }
  ...
  window.InputFileChange = function () {
    if (this.files[0]) {
      var photoName = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this)[0].files[0].name;
      var dataId = this.closest('div').getAttribute("data-el-id");
      var fr = new FileReader(),
          $shopBlock = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest(".upload-gallery");
      console.log($shopBlock);
      fr.addEventListener("load", function (e) {
        var $photos = $shopBlock.find('.upload-load-photo');
        $photos.append("<div class='photo' data-el-id='" + dataId + "'>\
					<img src='" + fr.result + "' />\
					<div class='photo-title'>'" + photoName + "'</div>\
					<div class='photo-del'>Удалить фото</div>\
	    			</div>");
      }, false);
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').on('click', ".photo-del", function () {
    var $this = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    var elId = $this.closest('.photo').attr("data-el-id");
    $this.closest('.upload-gallery').find('.forms__input-cont--multiple .forms-input-cont--file[data-el-id="' + elId + '"]').remove();
    $this.closest('.photo').remove();
  });
  if (!jquery__WEBPACK_IMPORTED_MODULE_0___default()(".upload__item-el--photo input[type='file']").length) return;
  var fileInputs = document.querySelectorAll(".upload__item-el--photo input[type='file']");
  var _iteratorNormalCompletion2 = true;
  var _didIteratorError2 = false;
  var _iteratorError2 = undefined;

  try {
    for (var _iterator2 = fileInputs[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {

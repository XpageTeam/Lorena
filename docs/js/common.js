...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! swiper/dist/js/swiper.esm */ "./node_modules/swiper/dist/js/swiper.esm.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, swiper_esm_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    swiper_esm_1.Swiper.use([swiper_esm_1.Navigation, swiper_esm_1.Autoplay, swiper_esm_1.Pagination]);
    document.addEventListener("DOMContentLoaded", function () {
        document.querySelectorAll(".hit-slider").forEach(function (item) {
            new swiper_esm_1.Swiper(item.querySelector(".hit-slider__slider"), {
                slidesPerView: 4,
                autoplay: true,
                spaceBetween: 44,
                navigation: {
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! ./app */ "./src/ts/app.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, app_1) {
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    document.addEventListener("DOMContentLoaded", function () {
        new app_1.EventListener(".card-tabs__tabs-tab").add("click", function (el, e) {
            if (el.classList.contains("active"))
                return;
            var targetTab = el, targetTabID = el.getAttribute("data-id"), targetTabContent = document.querySelector(".ct-content__item[data-id=\"" + targetTabID + "\"]");
            var curActiveTab = document.querySelector(".card-tabs__tabs-tab.active"), curActiveTabID = curActiveTab.getAttribute("data-id"), curTabContent = document.querySelector(".ct-content__item[data-id=\"" + curActiveTabID + "\"]");
            curActiveTab.classList.remove("active");
            curTabContent.classList.remove("active");
            targetTab.classList.add("active");
            targetTabContent.classList.add("active");
        });
        new app_1.EventListener(".features__row--marked").add("click", function (el, e) {
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! ./app */ "./src/ts/app.ts"), __webpack_require__(/*! swiper/dist/js/swiper.esm.js */ "./node_modules/swiper/dist/js/swiper.esm.js"), __webpack_require__(/*! ./tovar */ "./src/ts/tovar.ts"), __webpack_require__(/*! ./timeline */ "./src/ts/timeline.ts"), __webpack_require__(/*! ./standart-page */ "./src/ts/standart-page.ts"), __webpack_require__(/*! ./addresses */ "./src/ts/addresses.ts"), __webpack_require__(/*! ./partners */ "./src/ts/partners.ts"), __webpack_require__(/*! ./career */ "./src/ts/career.ts"), __webpack_require__(/*! ./forms */ "./src/ts/forms.ts"), __webpack_require__(/*! ./reviews */ "./src/ts/reviews.ts"), __webpack_require__(/*! ./advantages */ "./src/ts/advantages.ts"), __webpack_require__(/*! ./nav-scrolling */ "./src/ts/nav-scrolling.ts"), __webpack_require__(/*! ./about */ "./src/ts/about.ts"), __webpack_require__(/*! ./card-tabs */ "./src/ts/card-tabs.ts"), __webpack_require__(/*! ./card-slider */ "./src/ts/card-slider.ts"), __webpack_require__(/*! ./eco-maniya */ "./src/ts/eco-maniya.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, app_1, swiper_esm_js_1) {
    ...
    app_1.App.domReady(function () {
        var header = document.querySelectorAll(".main .head, .tovar .head, .constructor .head");
        if (header.length == 0)
            return;
        checkWindowScrollForHeaderFix(header[0]);
    ...
    app_1.App.domReady(function () {
        ...
        var catalogFilter = new app_1.MobileMenu({
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! ./app */ "./src/ts/app.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, app_1) {
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    app_1.App.domReady(function () {
        var curInputs = app_1.App.elementsGetter(".default-input__input--file");
        for (var _i = 0, curInputs_1 = curInputs; _i < curInputs_1.length; _i++) {
            var input = curInputs_1[_i];
    ...
    function observerFileInput(input) {
        new app_1.EventListener(input).add("change", function (el) {
            var parent = el.closest(".default-input--file"), fileNameField = parent.querySelector(".default-input__label--file");
            console.log(el);
            if (el.files.length) {
                var names = [];

...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! gsap */ "./node_modules/gsap/index.js"), __webpack_require__(/*! ./app */ "./src/ts/app.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, gsap_1, app_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    document.addEventListener("DOMContentLoaded", function () {
        ...
        if (!document.querySelector(".fake-design"))
            return;
        var confirmBtn = document.querySelector(".fdt__btn .arrow-btn"), cancelBtn = document.querySelector(".fdt__link");
    ...
    function cancelFakeDesign() {
        ...
        var ivlev = document.querySelector(".angry-ivlev");
        if (!ivlev)
            return;
    ...
    function showIvlev() {
        setTimeout(function () {
            ...
            var backLink = ivlev.querySelector(".ait__link");
            if (!backLink)
                return;
    ...
    function showNewColor() {
        var fdLine = document.querySelector(".fake-design__line");
        if (!fdLine)
            return;
        var counter = {
            count: -window.innerHeight - window.innerHeight * .2
        };
        gsap_1.TweenLite.to(counter, 3, {
            count: window.innerHeight + window.innerHeight * .2,
            onStart: function () {
                fdLine.classList.add("js__animating");
            },
            onUpdate: function () {
                var fdlTop = window.get$(fdLine).position().top;
                app_1.App.each("body *:not(.js__fake-color):not(#content)", function (el) {
                    var elementTop = window.get$(el).position().top + window.get$(el).height() * .1;
                    if (fdlTop >= elementTop)
                        el.classList.add("js__fake-color");
                });
            },
            onComplete: function () {
                gsap_1.TweenLite.to(fdLine, .3, {
                    onComplete: function () {

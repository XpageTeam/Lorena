...
var _swiperEsm = __webpack_require__(337);

var _stringAnimate = __webpack_require__(339);

var _stringAnimate2 = _interopRequireDefault(_stringAnimate);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_swiperEsm.Swiper.use([_swiperEsm.Lazy]);

document.addEventListener("DOMContentLoaded", function (e) {
	;(function () {
		var mainSlider = new _swiperEsm.Swiper(".main-slider", {
			loop: true,
			// initialSlide: 1,
			lazy: {
				loadPrevNext: true
	...
	$(".main-slide__title-title").each(function (i, el) {
		var $this = $(el);

		new _stringAnimate2.default({
			selector: $this
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ssr_window__ = __webpack_require__(130);
/**
 * Swiper 4.5.0
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_ssr_window__ = __webpack_require__(130);
/**
 * Dom7 2.1.3
...
var stringEffect = function () {
	...
	function stringEffect() {
		...
		_classCallCheck(this, stringEffect);
	...
	stringEffect.prototype.init = function init() {
		this.wrapWords();
		this.createStrings();
		this.afterFinish();
	...
	stringEffect.prototype.rebuild = function rebuild() {
		this.destroyStrings();
		this.createStrings();
	};

	stringEffect.prototype.wrapWords = function wrapWords() {
		this.beforeStart();

		var textArr = this.$el.html().split(/\s+(?![^<>]*>)/g);

		this.$el.html("");

		for (var _iterator = textArr, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
			var _ref;
	...
	stringEffect.prototype.destroyStrings = function destroyStrings() {
		this.$el.children("div").children("span").unwrap();
	};

	stringEffect.prototype.createStrings = function createStrings() {
	...
	stringEffect.prototype.wrapStrings = function wrapStrings() {
		var stringsDesc = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];

		this.stringCounter = 0;

		var _settings$options = this.settings.options,
		    delay = _settings$options.timeStep,
		    tmOffset = _settings$options.timeOffset,
		    transStep = _settings$options.transformStep,
		    transStepOffset = _settings$options.transformStepOffset;


		for (var _iterator2 = stringsDesc, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();;) {
			var _ref2;
			...
			var time = tmOffset + this.stringCounter * delay,
			...
			if (!this.$el.find(".string--" + word.top).length) {
				this.$el.append("<div class=\"string string--" + word.top + "\">\
					 <span>" + this.$el.children("span:eq(" + word.id + ")").html() + "</span>\
				</div>");
			...
			} else this.$el.find(".string--" + word.top).append(" <span>" + this.$el.children("span:eq(" + word.id + ")").html() + "</span>");
		}

		this.$el.children("span").remove();
	};

	stringEffect.prototype.whatch = function whatch() {
		var _this = this;

		$(window).on("resize", function (e) {
			clearTimeout(_this.updateTimeout);

			_this.updateTimeout = setTimeout(function (e) {
				_this.rebuild();
			}, 100);
		});
	};
